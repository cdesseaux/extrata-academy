  ...
  app.use(helmet({
    contentSecurityPolicy: {
      directives: {
        ...
        scriptSrc: ["'self'"],
        imgSrc: ["'self'", "data:", "https:", "https://*.amazonaws.com", "https://s3.amazonaws.com"],
        connectSrc: ["'self'", "https://keycloak-hlg.extrata.com.br", "https://*.amazonaws.com", "https://s3.amazonaws.com"],
        fontSrc: ["'self'"],
        objectSrc: ["'none'"],
        mediaSrc: ["'self'", "https:", "https://*.amazonaws.com", "https://s3.amazonaws.com"],
        frameSrc: ["'none'"],
      },
    },
